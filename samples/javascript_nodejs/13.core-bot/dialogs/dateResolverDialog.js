...
class DateResolverDialog extends CancelAndHelpDialog {
    ...
    async initialStep(stepContext) {
        ...
        const promptMessageText = 'On what date would you like to book the appointment?';
        const promptMessage = MessageFactory.text(promptMessageText, promptMessageText, InputHints.ExpectingInput);

        const repromptMessageText = "I'm sorry, for best results, please enter your intended appointment date including the month, day and year.";
